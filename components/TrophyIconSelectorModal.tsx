  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Select a Trophy Icon" className="z-[60]">
        <div className="space-y-4">
            <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-2">Pre-designed Icons</h4>
                <div className="grid grid-cols-4 sm:grid-cols-6 gap-4 p-2 bg-gray-900/50 rounded-md">
                    ...
                    <button
                        ...
                        className="p-2 bg-gray-700/50 rounded-lg flex items-center justify-center aspect-square transition-all duration-200 hover:bg-blue-600/50 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500"
             ...
             <div>
                <h4 className="text-lg font-semibold text-blue-300 mb-2">Custom Icon</h4>
                 <input
                    type="file"
                    ref={uploadRef}
                    className="hidden"
